...
namespace TaskManagement.Tests.Models.Tests
{
    ...
    public class TeamTests
    {
        ...
        {
            //Arrange
            string name = new string('x', NameMaxLen - 1);
        ...
        public void AddBoard_Should_AddBoardToTeamList()
        {
            ...
            var team = new Team(new string('x', NameMinLen + 1));
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException), "AddBoard failed and added null value!")]
        ...
        {
            //Arrange
            var member = new Member(new string('x', NameMinLen + 1));
            var team = new Team(new string('x', NameMinLen + 1));
